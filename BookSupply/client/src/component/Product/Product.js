...
const Product = () => {
    ...
    const [updateCartText, setUpdateCartText] = useState("Add to")
    useEffect(()=>{
      ...
      <MetaData title = {product.name}/>
...

        {
          ...
          <div className="flex flex-col">
                  ...
                  <Button disabled = {product.stock < 1 ? true :false} onClick={addToCartHandler} className="text-white bg-blue-700 rounded-lg normal-case"> {updateCartText} Cart</Button>
                  </div>
          </div>
        }
