    ...
    form: {
      autocomplete: 'off',
        ...
        <div className='flex flex-col mt-16 gap-4 align-middle justify-center'>
            <Button onClick={handleSubmit} className='text-white bg-blue-700 rounded-lg normal-case hover:scale-105'>{isSignUp ? 'Sign Up':'Sign In'}</Button>
            <Button onClick={switchMode} className='text-white bg-blue-700 rounded-lg normal-case hover:scale-105'>{isSignUp ? "Already have an account? Sign In" : "Don't have an account? Sign Up"}</Button>
            {
              isSignUp && (
                <>
                {/* <Button onClick={handleSwitchRole} className='text-white bg-blue-700 rounded-lg normal-case'>Sign Up as a Seller</Button> */}
