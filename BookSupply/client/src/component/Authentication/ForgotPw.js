            ...
            <Paper elevation={3} className="flex-col align-middle p-10">
                ...
                <form action="" onSubmit={forgotHandler}>
                    ...
                    <Grid container spacing={2} className='gap-[30px]'>
                        ...
                        <Button fullWidth onClick={forgotHandler} className="text-white bg-blue-700 rounded-lg normal-case hover:scale-105">Reset Password</Button>
                    </Grid>
