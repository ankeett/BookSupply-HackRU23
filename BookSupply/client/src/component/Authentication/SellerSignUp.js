    ...
    form: {
      autocomplete: 'off',
        ...
        <div className='flex flex-col mt-16 gap-8 align-middle justify-center'>
            <Button onClick={handleSubmit} className='text-white bg-blue-700 rounded-lg normal-case hover:scale-105'>Sign Up as a Company</Button>
            <Button onClick={handleSwitchRole} className='text-white bg-blue-700 rounded-lg normal-case hover:scale-105'>Sign In</Button>
