    ...
    <div className="flex shadow-md my-10">
      <div className="w-3/4 bg-white px-10 py-10">
        ...
        : <div className='mt-[150px] flex flex-col items-center justify-center'>
          ...
          <Button onClick={()=>{navigate('/buy')}} size='large' className='text-white bg-blue-700 rounded-lg normal-case'>View Products</Button>
      ...
      <div id="summary" className="w-1/4 px-8 py-10">
        ...
        <div className="border-t mt-8">
          ...
          <Button onClick={checkOutHandler} disabled = {cartItems.length < 1 ? true:false} fullWidth className='text-white bg-blue-700 rounded-lg normal-case'>Checkout</Button>
        </div>
      </div>
