...
const Sell = () => {  
  ...
  const handleSubmit = (e) =>{
    ...
    dispatch(createProduct(name, description, price,category,subcategory,stock,height,width,length, images));
      ...
      <Paper elevation={3} className="flex-col p-10 align-middle ">
        ...
        <form action="" ref={formRef} onSubmit={handleSubmit}>
            <Grid container spacing ={2} className='gap-[30px]'>
                ...
                <TextField required type="number"  fullWidth name='stock' label="Stock" onChange = {(e)=>{setStock(e.target.value)}} InputProps={{inputProps:{min:0}}}/>
